...
class UltrasoundDataset(BaseDataset):
    """
    Dataset V7 (Final Perfection):
    1. 补全 'case_name' 键，彻底消除 KeyError。
    2. 保留所有之前的修复 (NII支持, 同步裁剪, 双键名hq/sq)。
    """
    def __init__(self, opt):
        ...
        print(f"Dataset V7 (Final). Found {len(self.lq_paths)} pairs.")
